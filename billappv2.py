...
def company_details_obj():
    ...
    #Company Adress
    company_contact_number_lbl=Label(company_details_frame,text="Company Adress",font=book_antiqua,bg=frame_color,fg=element_color)
...
def billing_obj():
    ...
    billing_customer_name_tb=Entry(billing_frame,fg=element_color,bg=element_color_dark,font=arial,border=4,width=30)
...
def purchase_obj():
    ...
    purchase_details_lbl=Label(purchase_frame,text="Purchase Details",font=book_antiqua_size18,bg=frame_color,fg=element_color)
    ...
    #Purchase Add Button
    purchase_add_update_btn=Button(purchase_frame,fg=element_color,bg=element_color_dark,text="Add",width = 21,border=4,command=lambda:[])
    ...
    #Purchase save
    purchase_print_button=Button(purchase_frame,fg=element_color,bg=element_color_dark,text="Save",width = 16,height=2,border=4,command=lambda:[])
...
def customer_detail_obj():
    ...
    customer_detail_bill_number_lbl=Label(customer_detail_frame,text="Bill Number",font=book_antiqua,bg=frame_color,fg=element_color)
    customer_detail_bill_number_lbl.place(relx = 0.5, rely = 0.14, anchor = NW)

    customer_detail_bill_number_tb=Entry(customer_detail_frame,fg=element_color,bg=element_color_dark,font=arial,border=4)
...
def item_obj():
    ...
    item_lbl=Label(item_frame,text="Add Items",font=book_antiqua_size18,bg=frame_color,fg=element_color)
    ...
    #Id auto gen label
    item_id_lbl=Label(item_frame,text="ID-Auto Gen",font=book_antiqua,bg=frame_color,fg=element_color)
...
def report_obj():
    ...
    #Show details btn
    report_shoe_details_btn=Button(report_frame,fg=element_color,bg=element_color_dark,text="Show Details",width = 16,border=4,command=lambda:[])
    report_shoe_details_btn.place(relx = 0.365, rely = 0.19, anchor = NW)
